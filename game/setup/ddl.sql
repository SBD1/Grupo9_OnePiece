...
CREATE TABLE personagem_nao_hostil (
    id_personagem INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) NOT NULL,
    nome VARCHAR(20) NOT NULL,
    ocupacao personagem_ocupacao NOT NULL,
    grupo_ocupacao TEXT NOT NULL,
    ...
    CONSTRAINT fk_missao_personagem_nao_hostil FOREIGN KEY (id_missao) 
...
CREATE TABLE poder_especial (
    ...
    CONSTRAINT fk_personagem_principal FOREIGN KEY (id_personagem_principal) 
        REFERENCES personagem_principal(idPersonagem) ON DELETE RESTRICT
);
...
CREATE TABLE objetivo (
    ...
    CONSTRAINT fk_npc FOREIGN KEY (id_npc)
        REFERENCES npc(id_npc) ON DELETE RESTRICT
);

...
CREATE TABLE IF NOT EXISTS personagem_principal (
    ...
    id_regiao_anterior INTEGER DEFAULT 1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS jogador (
    ...
    id_personagem INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) NOT NULL,
    id_regiao INTEGER NOT NULL,
    id_regiao_anterior INTEGER NOT NULL,
    nome VARCHAR(20) NOT NULL,
    ocupacao personagem_ocupacao NOT NULL,
    grupo_ocupacao personagem_grupo_ocupacao NOT NULL,
    berries INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS conversa_concluida (
    id_personagem INTEGER NOT NULL, 
    id_conversa INTEGER NOT NULL,
    id_jogador_save VARCHAR(30) NOT NULL,
    id_jogador_personagem INTEGER NOT NULL,

    CONSTRAINT fk_conversa FOREIGN KEY (id_personagem, id_conversa)
        REFERENCES conversa(id_personagem, id_conversa),
    CONSTRAINT fk_jogador FOREIGN KEY (id_jogador_save,id_jogador_personagem)
        REFERENCES jogador(nome_save,id_personagem),

    PRIMARY KEY (id_personagem, id_conversa, id_jogador_save, id_jogador_personagem)
);

CREATE TABLE IF NOT EXISTS fala (
    id_personagem INTEGER NOT NULL,
    id_conversa INTEGER NOT NULL,
    id_fala INTEGER NOT NULL,
    texto TEXT NOT NULL,
    nome_display VARCHAR(30) NOT NULL,

    CONSTRAINT fk_conversa FOREIGN KEY (id_personagem, id_conversa)
        REFERENCES conversa(id_personagem, id_conversa),

    PRIMARY KEY (id_personagem, id_conversa, id_fala)
);
...
CREATE TABLE IF NOT EXISTS objetivo (
    ...
    id_conversa_personagem INTEGER NULL,
    id_conversa INTEGER NULL,
    ...
    CONSTRAINT fk_conversa FOREIGN KEY (id_conversa_personagem, id_conversa)
        REFERENCES conversa(id_personagem, id_conversa) ON DELETE RESTRICT
);
